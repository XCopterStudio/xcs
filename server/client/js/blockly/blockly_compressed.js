...
goog.events.ListenerMap.prototype.add = function (a, b, c, d, e) {
    ...
    var g = goog.events.ListenerMap.findListenerIndex_(f, b, d, e); - 1 < g ? (a = f[g], c || (a.callOnce = !1)) : (a = new goog.events.Listener(b, null, this.src, a, !! d, e), a.callOnce = c, f.push(a));
    return a
};
...
goog.events.removeAll = function (a, b) {
    ...
    for (e in c.listeners)
        if (!b || e == b)
            for (var f = goog.array.clone(c.listeners[e]), g = 0; g < f.length; ++g) goog.events.unlistenByKey(f[g]) && ++d;
    return d
};
...
goog.events.KeyHandler.prototype.handleKeyDown_ = function (a) {
    goog.userAgent.WEBKIT && (this.lastKey_ == goog.events.KeyCodes.CTRL && !a.ctrlKey || this.lastKey_ == goog.events.KeyCodes.ALT && !a.altKey || goog.userAgent.MAC && this.lastKey_ == goog.events.KeyCodes.META && !a.metaKey) && (this.keyCode_ = this.lastKey_ = -1); - 1 == this.lastKey_ && (a.ctrlKey && a.keyCode != goog.events.KeyCodes.CTRL ? this.lastKey_ = goog.events.KeyCodes.CTRL : a.altKey && a.keyCode != goog.events.KeyCodes.ALT ? this.lastKey_ = goog.events.KeyCodes.ALT : a.metaKey &&
...
goog.ui.ControlRenderer.prototype.decorate = function (a, b) {
    ...
    l && k.push.apply(k, l);
    if (goog.userAgent.IE && !goog.userAgent.isVersionOrHigher("7")) {
        var q = this.getAppliedCombinedClassNames_(k);
        0 < q.length && (k.push.apply(k, q), c = !0)
    }
...
goog.ui.PaletteRenderer.prototype.highlightCell = function (a, b, c) {
    b && (b = this.getCellForItem(b), goog.dom.classlist.enable(b, this.getCssClass() + "-cell-hover", c), goog.a11y.aria.setState(a.getElementStrict(), goog.a11y.aria.State.ACTIVEDESCENDANT, b.id))
};
...
goog.ui.PaletteRenderer.prototype.selectCell = function (a, b, c) {
    b && goog.dom.classlist.enable(b.parentNode, this.getCssClass() + "-cell-selected", c)
};
            ...
            try {
                if (goog.isDef(a))
                    ...
                    if (c.contains(a)) d.push("*** reference loop detected ***");
                        ...
                        d.push("{");
                        for (var k in a)
                            if (b || !goog.isFunction(a[k])) d.push("\n"), d.push(h), d.push(k + " = "), e(a[k], h);
                        d.push("\n" + g + "}")
                    } else d.push(a);
...
goog.cssom.addCssRule = function (a, b, c) {
    if (0 > c || void 0 == c) c = (a.cssRules || a.rules).length;
...
Blockly.BlockSvg.prototype.renderCompute_ = function (a) {
    ...
    for (var d = 0, e = 0, f = !1, g = !1, h = !1, k = void 0, l = this.block_.inputsInline && !this.block_.isCollapsed(), q = 0, m; m = b[q]; q++)
        if (m.isVisible()) {
            var p;
            l && k && k != Blockly.NEXT_STATEMENT && m.type != Blockly.NEXT_STATEMENT ? p = c[c.length - 1] :
                (k = m.type, p = [], p.type = l && m.type != Blockly.NEXT_STATEMENT ? Blockly.BlockSvg.INLINE : m.type, p.height = 0, c.push(p));
            p.push(m);
            m.renderHeight = Blockly.BlockSvg.MIN_BLOCK_Y;
            m.renderWidth = l && m.type == Blockly.INPUT_VALUE ? Blockly.BlockSvg.TAB_WIDTH + Blockly.BlockSvg.SEP_SPACE_X : 0;
            ...
            for (var n = 0, r; r = m.fieldRow[n]; n++) 0 != n && (m.fieldWidth += Blockly.BlockSvg.SEP_SPACE_X), r = r.getSize(), m.fieldWidth += r.width, p.height = Math.max(p.height, r.height);
...
Blockly.BlockSvg.prototype.renderDraw_ = function (a, b) {
    if (this.block_.outputConnection) this.squareBottomLeftCorner_ = this.squareTopLeftCorner_ = !0;
        ...
        this.block_.nextConnection && (c = this.block_.nextConnection.targetBlock()) && c.previousConnection &&
...
Blockly.BlockSvg.prototype.renderDrawTop_ = function (a, b, c, d) {
    ...
    this.block_.previousConnection && (a.push("H", Blockly.BlockSvg.NOTCH_WIDTH -
        15), b.push("H", Blockly.BlockSvg.NOTCH_WIDTH - 15), a.push(Blockly.BlockSvg.NOTCH_PATH_LEFT), b.push(Blockly.BlockSvg.NOTCH_PATH_LEFT_HIGHLIGHT), this.block_.previousConnection.moveTo(c.x + (Blockly.RTL ? -Blockly.BlockSvg.NOTCH_WIDTH : Blockly.BlockSvg.NOTCH_WIDTH), c.y));
    a.push("H", d);
...
Blockly.BlockSvg.prototype.renderDrawRight_ = function (a, b, c, d, e, f, g) {
    for (var h, k = 0, l, q, m = 0, p; p = f[m]; m++) {
        ...
        } else p.type == Blockly.INPUT_VALUE ? (n = p[0], l = k + Blockly.BlockSvg.FIELD_HEIGHT, n.align != Blockly.ALIGN_LEFT && (r = f.rightEdge - n.fieldWidth - Blockly.BlockSvg.TAB_WIDTH - 2 * Blockly.BlockSvg.SEP_SPACE_X, n.align == Blockly.ALIGN_RIGHT ? h += r : n.align == Blockly.ALIGN_CENTRE && (h += (r + h) / 2)), this.renderFields_(n.fieldRow, h, l), a.push(Blockly.BlockSvg.TAB_PATH_DOWN), a.push("v", p.height - Blockly.BlockSvg.TAB_HEIGHT),
            Blockly.RTL ? (b.push(Blockly.BlockSvg.TAB_PATH_DOWN_HIGHLIGHT_RTL), b.push("v", p.height - Blockly.BlockSvg.TAB_HEIGHT)) : (b.push("M", f.rightEdge - 4.2 + "," + (k + Blockly.BlockSvg.TAB_HEIGHT - 0.4)), b.push("l", 0.42 * Blockly.BlockSvg.TAB_WIDTH + ",-1.8")), l = e.x + (Blockly.RTL ? -f.rightEdge - 1 : f.rightEdge + 1), q = e.y + k, n.connection.moveTo(l, q), n.connection.targetConnection && n.connection.tighten_()) : p.type == Blockly.DUMMY_INPUT ? (n = p[0], l = k + Blockly.BlockSvg.FIELD_HEIGHT, n.align != Blockly.ALIGN_LEFT && (r = f.rightEdge - n.fieldWidth -
            2 * Blockly.BlockSvg.SEP_SPACE_X, f.hasValue && (r -= Blockly.BlockSvg.TAB_WIDTH), n.align == Blockly.ALIGN_RIGHT ? h += r : n.align == Blockly.ALIGN_CENTRE && (h += (r + h) / 2)), this.renderFields_(n.fieldRow, h, l), a.push("v", p.height), Blockly.RTL && b.push("v", p.height - 2)) : p.type == Blockly.NEXT_STATEMENT && (n = p[0], 0 == m && (a.push("v", Blockly.BlockSvg.SEP_SPACE_Y), Blockly.RTL && b.push("v", Blockly.BlockSvg.SEP_SPACE_Y - 1), k += Blockly.BlockSvg.SEP_SPACE_Y), l = k + Blockly.BlockSvg.FIELD_HEIGHT, n.align != Blockly.ALIGN_LEFT && (r = f.statementEdge -
...
Blockly.BlockSvg.prototype.renderDrawBottom_ = function (a, b, c, d) {
    ...
    Blockly.BROKEN_CONTROL_POINTS && a.push("c 0,5 0,-5 0,0");
    this.squareBottomLeftCorner_ ? (a.push("H 0"), Blockly.RTL || b.push("M", "1," +
    ...
    for (var g = null, f = 0, h; h = b.childNodes[f]; f++)
        if (3 != h.nodeType || !h.data.match(/^\s*$/)) {
            ...
            case "comment":
                ...
                (g = h.getAttribute("pinned")) &&
                    d.comment.setVisible("true" == g);
        ...
        }(a = d.nextConnection && d.nextConnection.targetBlock()) ? a.render(): d.render();
    (b =
        b.getAttribute("collapsed")) && d.setCollapsed("true" == b);
    return d
};
...
Blockly.Tooltip.onMouseMove_ = function (a) {
    if (Blockly.Tooltip.element_ && Blockly.Tooltip.element_.tooltip && 0 == Blockly.Block.dragMode_ && !Blockly.WidgetDiv.isVisible())
        ...
        } else Blockly.Tooltip.poisonedElement_ != Blockly.Tooltip.element_ && (window.clearTimeout(Blockly.Tooltip.showPid_), Blockly.Tooltip.lastXY_ =
...
Blockly.Block.prototype.getRelativeToSurfaceXY = function () {
    ...
    if (this.svg_) {
        ...
        a = a + d.x, b = b + d.y, c = c.parentNode;
...
Blockly.Block.prototype.getHeightWidth = function () {
    ...
    Blockly.BROKEN_CONTROL_POINTS && (b -= 10, this.nextConnection && (b += 4));
    return {
        height: b - 1,
        width: a.width
    }
...
Blockly.Block.prototype.showContextMenu_ = function (a) {
    if (!Blockly.readOnly && this.contextMenu) {
        ...
        if (this.isDeletable() && !b.isInFlyout) {
            ...
            c.push(d);
            this.isEditable() && !this.collapsed_ && (d = {
                enabled: !0
    ...
    for (var e = a.split(this.interpolateMsg.SPLIT_REGEX_), f = [], g = 0; g < e.length; g += 2) {
        ...
        if ((h = e[g + 1]) && "%" == h.charAt(0)) {
            var l = parseInt(h.substring(1), 10),
                q = arguments[l];
            goog.asserts.assertArray(q, 'Message symbol "%s" is out of range.', h);
            goog.asserts.assertArray(q, 'Argument "%s" is not a tuple.', h);
            q[1] instanceof Blockly.Field ? f.push([q[0], q[1]]) : k = this.appendValueInput(q[0]).setCheck(q[1]).setAlign(q[2]);
            arguments[l] = null
...
Blockly.FieldTextInput.prototype.showEditor_ = function () {
    ...
    } else Blockly.WidgetDiv.show(this, this.widgetDispose_()), b = Blockly.WidgetDiv.DIV, a = goog.dom.createDom("input", "blocklyHtmlInput"), Blockly.FieldTextInput.htmlInput_ = a, b.appendChild(a), a.value = a.defaultValue = this.text_, a.oldValue_ = null, this.validate_(), this.resizeEditor_(),
...
Blockly.FieldAngle.prototype.onMouseMove = function (a) {
    ...
    b = Math.atan(-a / c);
    isNaN(b) || (b = b / Math.PI * 180, 0 > c ? b += 180 : 0 < a && (b += 360), Blockly.FieldAngle.ROUND && (b = Math.round(b / Blockly.FieldAngle.ROUND) * Blockly.FieldAngle.ROUND), 360 <= b && (b -= 360), b = String(b), Blockly.FieldTextInput.htmlInput_.value = b, this.setText(b))
};
...
Blockly.FieldDropdown = function (a, b) {
    ...
    this.value_ = c[1];
    var d = goog.userAgent.ANDROID ? "\u25bc" : "\u25be";
    this.arrow_ = Blockly.createSvgElement("tspan", {}, null);
    this.arrow_.appendChild(document.createTextNode(Blockly.RTL ? d + " " : " " + d));
...
Blockly.FieldDropdown.prototype.showEditor_ = function () {
    ...
    Blockly.RTL ? (e.x += f.width, e.x += Blockly.FieldDropdown.CHECKMARK_OVERHANG, e.x < d.x + h.width && (e.x = d.x + h.width)) : (e.x -= Blockly.FieldDropdown.CHECKMARK_OVERHANG, e.x > c.width +
        d.x - h.width && (e.x = c.width + d.x - h.width));
...
Blockly.FieldDropdown.prototype.setText = function (a) {
    ...
    null !== a && (this.text_ = a, goog.dom.removeChildren(this.textElement_), a = a.replace(/\s/g, Blockly.Field.NBSP), a || (a = Blockly.Field.NBSP), a = document.createTextNode(a), this.textElement_.appendChild(a), Blockly.RTL ? this.textElement_.insertBefore(this.arrow_, this.textElement_.firstChild) : this.textElement_.appendChild(this.arrow_), this.size_.width = 0, this.sourceBlock_ &&
        this.sourceBlock_.rendered && (this.sourceBlock_.render(), this.sourceBlock_.bumpNeighbours_(), this.sourceBlock_.workspace.fireChangeEvent()))
};
...
Blockly.Flyout.prototype.show = function (a) {
    ...
    if (a == Blockly.Variables.NAME_TYPE) Blockly.Variables.flyoutCategory(c, d, b, this.workspace_);
        ...
        for (var e = 0, f; f = a[e]; e++) f.tagName && "BLOCK" == f.tagName.toUpperCase() && (f = Blockly.Xml.domToBlock(this.workspace_, f), c.push(f), d.push(3 * b));
    a = b;
    for (e = 0; f = c[e]; e++) {
        for (var g = f.getDescendants(),
                h = 0, k; k = g[h]; h++) k.isInFlyout = !0, k.setCommentText(null);
        f.render();
        g = f.getSvgRoot();
        h = f.getHeightWidth();
    ...
    this.listeners_.push(Blockly.bindEvent_(this.svgBackground_, "mouseover", this, function (a) {
        a =
            this.workspace_.getTopBlocks(!1);
...
Blockly.Generator.prototype.blockToCode = function (a) {
    ...
    b = b.call(a, a);
    return goog.isArray(b) ? [this.scrub_(a, b[0]), b[1]] : this.scrub_(a, b)
};
...
Blockly.Generator.prototype.FUNCTION_NAME_PLACEHOLDER_REGEXP_ = RegExp(Blockly.Generator.prototype.FUNCTION_NAME_PLACEHOLDER_, "g");
...
"}", ".blocklyEditableText:hover>rect {", "  stroke-width: 2;", "  stroke: #fff;", "}", ".blocklySvg text {", "  -moz-user-select: none;", "  -webkit-user-select: none;", "  user-select: none;", "  cursor: inherit;", "}", ".blocklyHidden {", "  display: none;", "}", ".blocklyFieldDropdown:not(.blocklyHidden) {", "  display: block;", "}", ".blocklyTooltipBackground {", "  fill: #ffffc7;", "  stroke-width: 1px;", "  stroke: #d8d8d8;", "}", ".blocklyTooltipShadow,", ".blocklyDropdownMenuShadow {", "  fill: #bbb;", "  filter: url(#blocklyShadowFilter);",
...
"}", ".blocklyColourBackground {", "  fill: #666;", "}", ".blocklyScrollbarBackground {", "  fill: #fff;", "  stroke-width: 1;", "  stroke: #e4e4e4;", "}", ".blocklyScrollbarKnob {", "  fill: #ccc;", "}", ".blocklyScrollbarBackground:hover+.blocklyScrollbarKnob,", ".blocklyScrollbarKnob:hover {", "  fill: #bbb;", "}", ".blocklyInvalidInput {", "  background: #faa;", "}", ".blocklyAngleCircle {", "  stroke: #444;", "  stroke-width: 1;", "  fill: #ddd;", "  fill-opacity: .8;", "}", ".blocklyAngleMarks {", "  stroke: #444;",
"  stroke-width: 1;", "}", ".blocklyAngleGauge {", "  fill: #f88;", "  fill-opacity: .8;  ", "}", ".blocklyAngleLine {", "  stroke: #f00;", "  stroke-width: 2;", "  stroke-linecap: round;", "}", ".blocklyContextMenu {", "  border-radius: 4px;", "}", ".blocklyDropdownMenu {", "  padding: 0 !important;", "}", ".goog-option-selected .goog-menuitem-checkbox,", ".goog-option-selected .goog-menuitem-icon {", "  background: url(<<<PATH>>>/media/sprites.png) no-repeat 0 0 !important;", "}", ".blocklyToolboxDiv {", "  background-color: #ddd;",
"  display: none;", "  overflow-x: visible;", "  overflow-y: auto;", "  position: absolute;", "}", ".blocklyTreeRoot {", "  padding: 4px 0;", "}", ".blocklyTreeRoot:focus {", "  outline: none;", "}", ".blocklyTreeRow {", "  line-height: 22px;", "  height: 22px;", "  padding-right: 1em;", "  white-space: nowrap;", "}", '.blocklyToolboxDiv[dir="RTL"] .blocklyTreeRow {', "  padding-right: 0;", "  padding-left: 1em !important;", "}", ".blocklyTreeRow:hover {", "  background-color: #e4e4e4;", "}", ".blocklyTreeIcon {", "  height: 16px;",
"  width: 16px;", "  vertical-align: middle;", "  background-image: url(<<<PATH>>>/media/tree.png);", "}", ".blocklyTreeIconClosedLtr {", "  background-position: -32px -1px;", "}", ".blocklyTreeIconClosedRtl {", "  background-position: 0px -1px;", "}", ".blocklyTreeIconOpen {", "  background-position: -16px -1px;", "}", ".blocklyTreeIconNone {", "  background-position: -48px -1px;", "}", ".blocklyTreeSelected>.blocklyTreeIconClosedLtr {", "  background-position: -32px -17px;", "}", ".blocklyTreeSelected>.blocklyTreeIconClosedRtl {",
"  background-position: 0px -17px;", "}", ".blocklyTreeSelected>.blocklyTreeIconOpen {", "  background-position: -16px -17px;", "}", ".blocklyTreeSelected>.blocklyTreeIconNone {", "  background-position: -48px -17px;", "}", ".blocklyTreeLabel {", "  cursor: default;", "  font-family: sans-serif;", "  font-size: 16px;", "  padding: 0 3px;", "  vertical-align: middle;", "}", ".blocklyTreeSelected  {", "  background-color: #57e !important;", "}", ".blocklyTreeSelected .blocklyTreeLabel {", "  color: #fff;", "}", ".goog-palette {",
...
Blockly.parseOptions_ = function (a) {
    ...
    if (b) var c = !1,
    d = !1, e = !1, f = null;
    else(f = a.toolbox) ? ("string" != typeof f && "undefined" == typeof XSLTProcessor && (f = f.outerHTML), "string" == typeof f && (f = Blockly.Xml.textToDom(f)), c = !! f.getElementsByTagName("category").length) : (f = null, c = !1), d = a.trashcan, void 0 === d && (d = c), e = a.collapse, void 0 === e && (e = c); if (f && !c) var g = !1;
    else g = a.scrollbars, void 0 === g && (g = !0);
    var h = !! a.realtime;
    return {
        RTL: !! a.rtl,
        collapse: e,
        ...
        languageTree: f,
        enableRealtime: h,
        realtimeOptions: h ? a.realtimeOptions : void 0
    }
};
Blockly.createDom_ = function (a) {
    ...
    Blockly.readOnly ||
        (Blockly.hasCategories ? Blockly.Toolbox.createDom(b, a) : (Blockly.mainWorkspace.flyout_ = new Blockly.Flyout, c = Blockly.mainWorkspace.flyout_, d = c.createDom(), c.init(Blockly.mainWorkspace, !0), c.autoClose = !1, goog.dom.insertSiblingBefore(d, Blockly.mainWorkspace.svgGroup_), Blockly.addChangeListener(function () {
        if (0 == Blockly.Block.dragMode_) {
            var a = Blockly.mainWorkspace.getMetrics();
            if (0 > a.contentTop || a.contentTop + a.contentHeight > a.viewHeight + a.viewTop || a.contentLeft < (Blockly.RTL ? a.viewLeft : 0) || a.contentLeft +
                a.contentWidth > a.viewWidth + (Blockly.RTL ? 2 : 1) * a.viewLeft)
                for (var b = Blockly.mainWorkspace.getTopBlocks(!1), c = 0, d; d = b[c]; c++) {
                    var e = d.getRelativeToSurfaceXY(),
                        q = d.getHeightWidth(),
                        m = a.viewTop + 25 - q.height - e.y;
                    0 < m && d.moveBy(0, m);
                    m = a.viewTop + a.viewHeight - 25 - e.y;
                    0 > m && d.moveBy(0, m);
                    m = 25 + a.viewLeft - e.x - (Blockly.RTL ? 0 : q.width);
                    0 < m && d.moveBy(m, 0);
                    m = a.viewLeft + a.viewWidth - 25 - e.x + (Blockly.RTL ? q.width : 0);
                    0 > m && d.moveBy(m, 0);
...
Blockly.init_ = function () {
    if (goog.userAgent.WEBKIT) {
        var a = Blockly.createSvgElement("path", {
    ...
    Blockly.documentEventsBound_ || (Blockly.bindEvent_(window, "resize", document, Blockly.svgResize), Blockly.bindEvent_(document, "keydown", null, Blockly.onKeyDown_), document.addEventListener("mouseup", Blockly.onMouseUp_, !1), goog.userAgent.IPAD && Blockly.bindEvent_(window, "orientationchange", document, function () {
        Blockly.fireUiEvent(window, "resize")
...
Blockly.bindEvent_ = function (a, b, c, d) {
    ...
    var f = [[a, b, e]];
    b in Blockly.bindEvent_.TOUCH_MAP && (e = function (a) {
        ...
        d.apply(c, arguments);
        a.preventDefault()
    }, a.addEventListener(Blockly.bindEvent_.TOUCH_MAP[b], e, !1), f.push([a, Blockly.bindEvent_.TOUCH_MAP[b], e]));
    return f
};
...
Blockly.onMouseDown_ = function (a) {
    ...
    Blockly.isRightButton(a) ? Blockly.showContextMenu_(a) : (Blockly.readOnly || b) && Blockly.mainWorkspace.scrollbar && (Blockly.mainWorkspace.dragMode = !0, Blockly.mainWorkspace.startDragMouseX = a.clientX, Blockly.mainWorkspace.startDragMouseY = a.clientY, Blockly.mainWorkspace.startDragMetrics =
        Blockly.mainWorkspace.getMetrics(), Blockly.mainWorkspace.startScrollX = Blockly.mainWorkspace.scrollX, Blockly.mainWorkspace.startScrollY = Blockly.mainWorkspace.scrollY)
};
...
Blockly.onKeyDown_ = function (a) {
    if (!Blockly.isTargetInput_(a))
        ...
        a.preventDefault()
    } else if (a.altKey || a.ctrlKey || a.metaKey) Blockly.selected && Blockly.selected.isDeletable() && Blockly.selected.workspace == Blockly.mainWorkspace && (Blockly.hideChaff(), 67 == a.keyCode ? Blockly.copy_(Blockly.selected) : 88 == a.keyCode && (Blockly.copy_(Blockly.selected),
...
Blockly.loadAudio_ = function (a, b) {
    if (window.Audio && a.length) {
        ...
        c && c.play && (c.volume = 0.01, c.play(), Blockly.SOUNDS_[b] = c)
    }
};
...
Blockly.getMainWorkspaceMetrics_ = function () {
    ...
    if (Blockly.mainWorkspace.scrollbar) var f = Math.min(d.x - b / 2, d.x + d.width - b),
    b = Math.max(d.x + d.width + b / 2, d.x + b), g = Math.min(d.y - c / 2, d.y + d.height - c), c = Math.max(d.y + d.height + c / 2, d.y + c);
    else f = d.x, b = f + d.width, g = d.y, c = g + d.height;
    return {
        viewHeight: a.height,
        viewWidth: a.width,
        contentHeight: c - g,
