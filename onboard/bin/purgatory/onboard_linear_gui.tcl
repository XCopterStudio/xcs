...
button .buttons.startall -text "Start ALL" -command { cmd "a.adjust()," }
pack .buttons.startall -side left

button .buttons.stopall -text "Stop ALL" -command { cmd "a.tadjust.stop();" }
...
scale .yaw.sleep -label "yaw sleep" \
-length 140 -from 0 -to 1 \
-command { setParam "a.yawSleep" } \
-resolution 0.01 \
-digits 3 \
-variable yawsleep \
-showvalue 1 -orient horizontal
...
scale .yaw.threshold -label "yaw threshold" \
-length 140 -from 0 -to 0.5 \
-command { setParam "a.yawThreshold" } \
-resolution 0.05 \
-digits 3 \
-variable yawthreshold \
-showvalue 1 -orient horizontal
pack .yaw.threshold
...
#set rollint 1
set rollsleep 0.2
set rollthreshold 0.15

set yawpval 1.5
set yawival 0.0
set yawdval 0
set yawsleep 0.3
set yawthreshold 0.15
